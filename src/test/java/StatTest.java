...
public class StatTest {
  ...
  public void assignLHSRHSStatementTokenizesAndParsesCorrectly() {
    ...
    String treeResult =
        "(prog begin (stat (assignLHS x) = " + "(assignRHS (expr (intLiter 5)))) end <EOF>)";
    String program = "begin\n" + "x = 5\n" + "end";
  ...
  public void ifStatementTokenizesAndParsesCorrectly() {
    ...
    String treeResult = "(prog begin (stat if (expr x) then " + "(stat print (expr y)) else "
  ...
  public void whileStatementTokenizesAndParsesCorrectly() {
    ...
    String treeResult =
        "(prog begin (stat while (expr x) do " + "(stat print (expr y)) done) end <EOF>)";
  ...
  public void statementRecursionTokenizesAndParsesCorrectly() {
    ...
    String treeResult =
        "(prog begin (stat (stat print (expr x)) ; " + "(stat print (expr y))) end <EOF>)";
    String program = "begin\n" + "print x;\n" + "print y\n" + "end";
